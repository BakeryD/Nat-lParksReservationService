...
INSERT INTO reservation (reservation_id, site_id, name, from_date, to_date) VALUES (1, 1, 'Smith Family Reservation', GETDATE()-2, GETDATE()+2);
INSERT INTO reservation (reservation_id, site_id, name, from_date, to_date) VALUES (2, 1, 'Lockhart Family Reservation', GETDATE()-6, GETDATE()-3);
INSERT INTO reservation (reservation_id, site_id, name, from_date, to_date) VALUES (3, 2, 'Jobs Family Reservation', GETDATE()+1, GETDATE()+4);
INSERT INTO reservation (reservation_id, site_id, name, from_date, to_date) VALUES (4, 2, 'Cook Family Reservation', GETDATE()+1, GETDATE()+4);
INSERT INTO reservation (reservation_id, site_id, name, from_date, to_date) VALUES (5, 3, 'Gates Reservation', GETDATE()+1, GETDATE()+4);
INSERT INTO reservation (reservation_id, site_id, name, from_date, to_date) VALUES (6, 3, 'Satya Nedella', GETDATE()+3, GETDATE()+10);
INSERT INTO reservation (reservation_id, site_id, name, from_date, to_date) VALUES (7, 4, 'Scott Gutherie', GETDATE()+10, GETDATE()+14);
INSERT INTO reservation (reservation_id, site_id, name, from_date, to_date) VALUES (8, 4, 'Marisa Mayer', GETDATE()-15, GETDATE()-10);
INSERT INTO reservation (reservation_id, site_id, name, from_date, to_date) VALUES (9, 5, 'Beth Mooney', GETDATE(), GETDATE()+4);
INSERT INTO reservation (reservation_id, site_id, name, from_date, to_date) VALUES (10, 5, 'Bill Board', GETDATE()-9, GETDATE()+1);
INSERT INTO reservation (reservation_id, site_id, name, from_date, to_date) VALUES (11, 5, 'Bill Loney', GETDATE()+1, GETDATE()+11);
INSERT INTO reservation (reservation_id, site_id, name, from_date, to_date) VALUES (12, 6, 'Simpson Family', GETDATE()-6, GETDATE()+1);
INSERT INTO reservation (reservation_id, site_id, name, from_date, to_date) VALUES (13, 6, 'Smith Family', GETDATE()+2, GETDATE()+11);
