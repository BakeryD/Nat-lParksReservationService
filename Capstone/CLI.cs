...
namespace Capstone
{
    public class CLI
    {
            ...
            do
            {
                ...
                switch (input)
                {
                    ...
                    case 2:     // Search Parkwide for a reservation
                        ...
                        break;
                    case 3:     //View all upcomming reservations in the next 30 days
                        PrintUpcommingReservations(currentPark);
                        break;
                }
            } while (input != 4);   // Continue until the user enters the quit command
        }
        ...
        private static int PrintParkMenu(Park currentPark)
        {
            ...
            // Return user input
            return CLIHelper.GetAnInteger(1, 4);
        }
		...
		private List<Site> PrintSiteList(DateTime startDate, DateTime endDate, List<Campground> campgrounds, int occupants, bool isAccessible, int RVLength, bool hasUtilities)
        {
            ...
            {
                List<Site> sites = siteDAL.FindAvailableSitesAdvanced(startDate, endDate, campground, occupants, isAccessible, RVLength, hasUtilities);
